...
// El JWT dura 2 horas y no sabe si al empleado lo bloquearon a mitad de
// turno. Este middleware sí vuelve a preguntarle a la base de datos.
export async function verificarActivo(req, res, next) {
  if (req.usuario?.rol !== "empleado") return next()
  try {
